      ...
      body: GridView.count(crossAxisCount: 2, children: <Widget>[
        ...
        Container(
          child: Card(
            ...
            child: Column(children: <Widget>[
              Image.network(
                "assets/image/ayqtnkkwo1234.jpg",
                height: 150.0,
                width: 200.0,
                fit: BoxFit.cover,
              ),
